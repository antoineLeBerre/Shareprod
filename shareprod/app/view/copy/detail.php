<?php 
	include "header.php";
?>
	<div class="resume-detail" background="">
	...
	<div class="commentaires-detail">
		...
		<div class="btn-commentaires-detail">Voir + de commentaires</div>
	</div>
	...
	<div class="faq-detail">
		...
		<div class="btn-faq-detail">Voir</div>
		<div class="scroll-top"></div>
	</div>
<?php 
	include "footer.php";
