<?php include_once ("app/view/layout/header.php") ?>
    ...
    <div id="container1">
 	<div class="lancerprojet">
 		...
 		<p></p>
 		<a href="?module=projet&action=create"><div class="btn-lancerprojet">Se lancer</div></a>
 	</div>
 	<div class="voirprojet">
 		 <div class="img-voirprojet"></div>
 		Je veux financer un projet
 		<p></p>
 		<a href="?module=projet&action=projets"><div class="btn-voirprojet">Explorer</div></a>
 	</div>
 ...
 <div id="container2">
 	...
 	<div class="cat">
        ...
        <?php foreach ($tabCategories as $tabCategory) { ?>
 		<a href="?module=projet&action=create&cat=<?= $tabCategory["id_cat"] ?>"><div class="cat1">
